...
class FoodMenuContent extends StatefulWidget {
  final ThemeColor color;
  const FoodMenuContent({super.key, required this.color});

  @override
  State<FoodMenuContent> createState() => _FoodMenuContentState();
}

class _FoodMenuContentState extends State<FoodMenuContent> with TickerProviderStateMixin {
