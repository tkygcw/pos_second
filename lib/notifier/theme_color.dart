...
//default color first login
  ...
  //         app_color_id: 0,
  //         background_color: '#' + ThemeColor().backgroundColor.value.toRadixString(16).substring(2),
  //         button_color: '#' + ThemeColor().buttonColor.value.toRadixString(16).substring(2),
  //         icon_color: '#' + ThemeColor().iconColor.value.toRadixString(16).substring(2),
  //         created_at: dateTime,
  //         updated_at: '',
  //         soft_delete: ''
  //     ));
